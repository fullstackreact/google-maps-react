    ...
    _createClass(Circle, [{
      ...
      value: function renderCircle() {
        ...
        var _props = this.props,
            ...
            _props$strokeColor = _props.strokeColor,
            strokeColor = _props$strokeColor === undefined ? "#FF0000" : _props$strokeColor,
            _props$strokeOpacity = _props.strokeOpacity,
            strokeOpacity = _props$strokeOpacity === undefined ? 0.8 : _props$strokeOpacity,
            _props$strokeWeight = _props.strokeWeight,
            strokeWeight = _props$strokeWeight === undefined ? 2 : _props$strokeWeight,
            _props$fillColor = _props.fillColor,
            fillColor = _props$fillColor === undefined ? "#FF0000" : _props$fillColor,
            _props$fillOpacity = _props.fillOpacity,
            fillOpacity = _props$fillOpacity === undefined ? 0.35 : _props$fillOpacity,
            _props$radius = _props.radius,
            radius = _props$radius === undefined ? 150 : _props$radius,
            props = _objectWithoutProperties(_props, ['map', 'google', 'positions', 'strokeColor', 'strokeOpacity', 'strokeWeight', 'fillColor', 'fillOpacity', 'radius']);
